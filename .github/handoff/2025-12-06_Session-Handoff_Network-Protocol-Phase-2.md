...
**Key pattern**: Leave protocol creates the _input_ for merge protocol. Phase 3 will consume departure reports and harvest PRs to synthesize learnings into parent nodes.

**Implementation approach**: Same as Phase 1 — workflow documentation serves as my operational instructions. I execute using available tools (git, file ops, GitHub MCP). No separate scripts needed because I _am_ the execution engine.
